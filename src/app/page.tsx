...
const features = [
  {
    ...
    title: "Smart Notes",
    desc: "Upload any PDF and get AI-generated study notes, summaries, and flashcards instantly.",
    color: "#3B82F6",
    bg: "#DBEAFE",
  },
  {
    ...
    desc: "Test your knowledge with AI-generated quizzes that adapt to your difficulty preference.",
    color: "#8B5CF6",
    bg: "#EDE9FE",
  },
  {
    ...
    title: "AI Tutor Chat",
    desc: "Ask questions and get clear, contextual explanations from your personal AI tutor.",
    color: "#F97316",
    bg: "#FFF7ED",
  },
  {
    ...
    desc: "Monitor your study streak, quiz scores, and identify areas that need more attention.",
    color: "#22C55E",
    bg: "#DCFCE7",
  },
];
...
const steps = [
  {
    ...
    title: "Upload Notes",
    desc: "Drop your lecture PDFs or paste your study material",
    color: "#3B82F6",
    bg: "#DBEAFE",
  },
  {
    ...
    title: "Study Smart",
    desc: "AI generates notes, flashcards, and quizzes for you",
    color: "#8B5CF6",
    bg: "#EDE9FE",
  },
  {
    ...
    title: "Master It",
    desc: "Track progress and ace your exams with confidence",
    color: "#22C55E",
    bg: "#DCFCE7",
  },
];
...
// Landing page: the hero, how it works, feature cards and footer.
// A faithful port of the reference design's Landing screen.
export default function LandingPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#FAFBFC" }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <HiOutlineBookOpen /> Create Account
            </motion.button>
            <motion.button
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.97 }}
      ...
      >
        <div>
          Built for <strong>Hackathon Sedia!</strong>
        </div>
        <div
          style={{
            display: "inline-flex",
