...
const resourceAlerts = [
  { id: 1, priority: 'High', subject: 'Form 4 Science', issue: '65% of students failing recent quizzes', recommendation: 'Allocate 2 more AI Tutor licenses or provide supplementary reading materials.' },
  { id: 2, priority: 'Medium', subject: 'Form 5 Mathematics', issue: 'Students struggling with Calculus', recommendation: 'Schedule a weekend remedial class.' },
  { id: 3, priority: 'Low', subject: 'Form 3 History', issue: 'Low engagement with generated notes', recommendation: 'Review syllabus alignment with teachers.' },
];

/**
 * AdminDashboard Component
 * A high-level mock view for school administrators.
 * Shows school-wide metrics (total students, active classes) and usage analytics
 * to track overall adoption and performance across the entire institution.
 */
