 ...
 * @property {string} qid Stable id, the storage key anchor for its schedule.
 * @property {string} stem Question text.
 * @property {string[]} options Exactly 4 distinct option strings.
 * @property {number} answerIndex Index into options, 0 to 3.
 * @property {string} explanation Always non-empty.
 */
 ...
 * @property {string} id Also the localStorage key suffix.
 * @property {string} subject For example "Sejarah", "Campuran" on the mix deck.
 * @property {string} title Deck button title line.
 * @property {string} topicId For example "sejarah-t4-bab-1".
 * @property {string} topicName Results topic card label.
 * @property {BankQuestion[]} questions The questions of the bank.
 */
...
/**
 * DeckOption
 * @typedef {Object} DeckOption
 * @property {string} id Deck id.
 * @property {string} subject Deck subject label.
 * @property {string} title Deck title.
 * @property {QuizBank[]} banks Banks a session draws from.
 */
