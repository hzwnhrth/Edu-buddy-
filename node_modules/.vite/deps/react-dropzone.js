...
import { t as require_jsx_runtime } from "./jsx-runtime-CoLOQQtA.js";
//#region node_modules/file-selector/dist/mime-default.js
/**
...
//#endregion
//#region node_modules/file-selector/dist/index.js
...
//#endregion
//#region node_modules/attr-accept/dist/index.js
...
var accepts = typeof accept === "function" ? accept : accept.default;
...
function evaluateDragFiles({ files, accept, minSize, maxSize, multiple, maxFiles = 0, validator, getErrorMessage }) {
	...
	files.forEach((file) => {
		...
		if (accepted && sizeMatch) acceptedFiles.push(file);
			...
			file,
			errors: [acceptError, sizeError].filter((error) => error != null).map((error) => localizeError(error, file))
		});
	});
...
function useDropzone(props = {}) {
	...
	const flatAccept = (0, import_react.useMemo)(() => flattenAccept(accept), [accept]);
	const acceptAttr = (0, import_react.useMemo)(() => acceptPropAsAcceptAttr(flatAccept), [flatAccept]);
	const inputAcceptAttr = (0, import_react.useMemo)(() => acceptPropAsAcceptAttr(flatAccept, { omitWildcardMimeTypesWithExtensions: true }), [flatAccept]);
	...
	const getRootProps = (0, import_react.useMemo)(() => ({ refKey = "ref", role, onKeyDown, onFocus, onBlur, onClick, onDragEnter, onDragOver, onDragLeave, onDrop, onPaste, ...rest } = {}) => ({
